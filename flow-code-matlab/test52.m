...
% test if it has been tiled from 4 parts into a whole one
 flo_filepath = 'C:\Users\23839\Desktop\RAFT-master\RAFT-master\after_tiling3\flow_00046_00047.flo';
 img_flo_f = readFlowFile(flo_filepath);
 out_f = flowToColor(img_flo_f);
 figure(1)
 imshow(out_f);
%%
raft_filepath = 'C:\Users\23839\Desktop\RAFT-master\RAFT-master\estimation_flo3\flow_00046_00047.flo';
img_flo_r = readFlowFile(raft_filepath);
out_r = flowToColor(img_flo_r);
figure(2)
imshow(out_r);
 %% gt
truth_path = 'C:\Users\23839\Desktop\RAFT-master\RAFT-master\datasets\Sintel\training\flow\bamboo_1\frame_0046.flo';
...
im_n = imread('frame2_0048.png');
im_np1 = imread('frame2_0049.png');
...
gt_filepath = 'C:\\Users\\23839\\Desktop\\RAFT-master\\RAFT-master\\datasets\\Sintel\\training\\flow\\bamboo_1\\frame_0046.flo';
