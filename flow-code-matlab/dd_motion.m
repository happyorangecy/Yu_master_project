...
%%
    % MSE
%     squared_error = (flow_tiling - flow_gt).^2;
%     mse = mean(squared_error(:));
%     mse_values(i) = mse;

     % MSE
%     squared_error = (flow_raft - flow_gt).^2;
%     mse = mean(squared_error(:));
%     mse_values(i) = mse;

    % Display the MAE for this file pair
    %fprintf('MAE for flow_000%02d_000%02d and frame_%04d: %f\n', i, i+1, i, mae);
